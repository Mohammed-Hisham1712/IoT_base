...
// EXECUTE_PROTO(SYSTEM_PARAM,SYSTEM_PARAM_INIT,BOOL*);
// EXECUTE_PROTO(SYSTEM_PARAM,SYSTEM_PARAM_FIRST_RUN,BOOL*);
// EXECUTE_PROTO(SYSTEM_PARAM,SYSTEM_PARAM_CHECK_FIRST_RUN,BOOL*);
